...
//                Gson gson = new Gson();
//
//                // Define the type for the ArrayList
//                Type userListType = new TypeToken<ArrayList<UserDetailsResult>>() {}.getType();
//
//                // Convert JSON array to ArrayList
//                List<UserDetailsResult> participantJsonList = gson.fromJson(result, userListType);
//
//
//
